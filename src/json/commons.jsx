...
export function formatToPhilippineCurrency(amount) {
...
export function GetPropertyStatus(status)
{
  switch(status)
  {
...
export function GetPropertyActivation(activation)
{
  switch(activation)
  {
    case 1 : return 'Draft'
...
export function CompareObjects(obj1, obj2) {
  ...
  for (let key in obj1) {
      // Check if obj2 has the same property and if the values differ
      if (obj2.hasOwnProperty(key) && obj1[key] !== obj2[key]) {
          // Store the property name and both values
          differences[key] = {
              obj1Value: obj1[key],
              obj2Value: obj2[key]
          };
