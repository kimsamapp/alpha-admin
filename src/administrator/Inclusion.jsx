...
const AInclusions = () => {
  ...
  useEffect(() => {
    dispatch(updateNavigation("Property Management - Inclusion"));
    onLoadFetchData();
  }, []);
  ...
  const onLoadFetchData = async () => {
    ...
    let res = await dispatch(GetInclusionById(param));
  ...
  const addName = async () => {
    ...
    let res = await dispatch(SaveInclusion(parameter));
    if (res.meta.requestStatus === "fulfilled") {
      toast.success("Inclusion successfully added.");
    } else if (res.meta.requestStatus === "rejected") {
      toast.error("Please contact administrator.");
    }
    setLoading(false);
  ...
  const updateName = async (objectValue) => {
    let parameter = {
      data: {
        ...
        name: editingName,
        apropertyInclusionid: objectValue.ApropertyInclusionId,
      },
      id: objectValue.ApropertyInclusionId,
    };
    let res = await dispatch(UpdateInclusion(parameter));
    if (res.meta.requestStatus === "fulfilled") {
      toast.success("Inclusion successfully updated.");
    } else if (res.meta.requestStatus === "rejected") {
      toast.error("Please contact administrator.");
    }
    setLoading(false);
  ...
  const deleteNameAPI = async () => {
    ...
    let res = await dispatch(DeleteInclusion(parameter));
    if (res.meta.requestStatus === "fulfilled") {
      toast.success("Inclusion successfully deleted.");
    } else if (res.meta.requestStatus === "rejected") {
      toast.error("Please contact administrator.");
    }
    setLoading(false);
  ...
  const deleteName = (index) => {
    ...
    setIdToDelete(index.ApropertyInclusionId);
  };
